...
<div class="shop-area">
    <div class="container">
        <div class="row">
            <!-- left-sidebar start -->
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 replace1">
                <!-- widget-categories start -->
                <aside class="widget widget-categories">
                    <h3 class="sidebar-title">Categories</h3>
                    <ul class="sidebar-menu">
                        <li><a href="unisexual.php">Unisexual</a> <span class="count">(2)</span></li>
                        <li><a href="kids.php">Kids</a> <span class="count">(8)</span></li>
                    </ul>
                </aside>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 replace2">
                <a href="#" class="fa fa-filter">Filter</a>
                            ...
                            <div class="row">
                                    ...
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img src="img/kidssweatshirt/ks4.jpeg" alt="" />
                                                <img class="secondary-img" src="img/kidssweatshirt/ks4.jpeg" alt="" />
                                            </a>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img src="img/kidssweatshirt/ks2.jpeg" alt="" />
                                                <img class="secondary-img" src="img/kidssweatshirt/ks2.jpeg" alt="" />
                                            </a>
                                            <span class="tag-line">new</span>
                                            <div class="product-action">
                                                <div class="button-top">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img src="img/kidssweatshirt/ks3.jpeg" alt="" />
                                                <img class="secondary-img" src="img/kidssweatshirt/ks3.jpeg" alt="" />
                                            </a>
                                            <span class="tag-line">new</span>
                                            <div class="product-action">
                                                <div class="button-top">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img src="img/kidsTshirt/k1.jpeg" alt="" />
                                                <img class="secondary-img" src="img/kidsTshirt/k1.jpeg" alt="" />
                                            </a>
                                            <span class="tag-line">new</span>
                                            <div class="product-action">
                                                <div class="button-top">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img src="img/kidsTshirt/k2.jpeg" alt="" />
                                                <img class="secondary-img" src="img/kidsTshirt/k2.jpeg" alt="" />
                                            </a>
                                            <span class="tag-line">new</span>
                                            <div class="product-action">
                                                <div class="button-top">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img src="img/kidsTshirt/k7.jpeg" alt="" />
                                                <img class="secondary-img" src="img/kidsTshirt/k7.jpeg" alt="" />
                                            </a>
                                            <span class="tag-line">new</span>
                                            <div class="product-action">
                                                <div class="button-top">
