            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="footer-logo">
                        <p class="logo1" style="margin-left: 430px;">Fashion Store</p></a>
                    ...
                    <div class="footer-widget">
                        ...
                        <ul class="footer-contact">
                            <li>
                                ...
                                Addresss: Sanjay Ghodawat University, Kolhapur.
                            </li>
                            <li>
                                <i class="fa fa-envelope"> </i>
                                Email: adityapatil210601@gmail.com
                            </li>
                            <li>
                                <i class="fa fa-phone"> </i>
                                Mobile: 9403408055, 9421745510.
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="copyright">
                        <p>aditya_creation <a href="#"></a>. All Rights Reserved</p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
